...
const validateDocumentData_1 = require("../utils/validateDocumentData");
...
documentationRouter.post("/upload", multer_config_1.upload.single("doc"), validateDocumentData_1.validateDocumentData, documentation_controller_1.uploadDocument);
